      ...
      <td colspan="3" style="color:${tcolor};"><b>${element.delayshow}</b></td>
          ...
          switch (markerLayer) {
            ...
            case "busstop":
              ...
              <table>
                <tbody>
                <img src="https://maps.googleapis.com/maps/api/streetview?size=500x500&location=${element.lat || element.stop_lat},${element.lon || element.stop_lon}&fov=80&heading=70&pitch=0&key=AIzaSyAwqhIOd8f0OCpiTxIE_TRy8Uo-H3UMhQY" width="300px">
                  <tr>
